		...
		while not do_quit:
			for event in pygame.event.get():
				if event.type == pygame.do_quit:
					...
					# events. That's why I'm dealing with the important things (quitting and resizing) out here. All other
					# inputs eventually get passed to the various modules and they can figure out what to do with them.
